...
#
# RPA4All branded fork — keep APPLICATION_SHORTNAME == APPLICATION_NAME to avoid migration issues
if(NEXTCLOUD_DEV)
    set( APPLICATION_NAME       "RPA4All FilesDev" )
    set( APPLICATION_SHORTNAME  "RPA4AllFilesDev" )
    set( APPLICATION_EXECUTABLE "rpa4all-files-dev" )
...
set( APPLICATION_SERVER_URL "https://nextcloud.rpa4all.com" CACHE STRING "URL for the server to use. If entered, the UI field will be pre-filled with it" )
set( APPLICATION_SERVER_URL_ENFORCE ON ) # Lock to RPA4All server
set( APPLICATION_REV_DOMAIN "com.rpa4all.files" )
set( DEVELOPMENT_TEAM "" CACHE STRING "Apple Development Team ID" )
set( APPLICATION_VIRTUALFILE_SUFFIX "rpa4all" CACHE STRING "Virtual file suffix (not including the .)")
...
## Theming options
set(NEXTCLOUD_BACKGROUND_COLOR "#0B6EA8" CACHE STRING "RPA4All primary brand color")
